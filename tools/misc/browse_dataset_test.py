...
def show_proj_bbox_img(idx,
    ...
    import cv2
    img_id = 2
    img = cv2.imread(img_metas['filename'][img_id]) # front or 
    # r_h, r_w,_ = img_metas['img_shape'][img_id]
    r_h, r_w, c, n = img_metas['img_shape']
    img = cv2.resize(img, (r_w, r_h))
    box = gt_bboxes
    lidar2img_rt = img_metas['lidar2img'][img_id]

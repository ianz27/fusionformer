...
class FusionDetrTransformerDecoderLayer(BaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 ffn_num_fcs=2,
                 **kwargs):
        super(FusionDetrTransformerDecoderLayer, self).__init__(
            attn_cfgs=attn_cfgs,
...
class BEVMSDeformableAttention(BaseModule):
    ...
    def forward(self,
        ...
        attention_weights = attention_weights.view(bs, num_query,
                                                   ...
                                                   self.num_points)
        # TODO: ??
        reference_points = reference_points[..., :2].unsqueeze(2)  # BS NUM_QUERY NUM_LEVEL 2
...
class FusionTransformerDecoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, return_intermediate=False, **kwargs):
        super(FusionTransformerDecoder, self).__init__(*args, **kwargs)
